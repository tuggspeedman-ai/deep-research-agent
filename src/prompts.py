...
<Available Tools>
1. **task(description, subagent_type)**: Delegate research tasks \
to specialized sub-agents
   - description: Clear, specific research question or task
   - subagent_type: Type of agent to use (e.g., "research-agent")
2. **think_tool(reflection)**: Reflect on the results of each \
delegated task and plan next steps.
   - reflection: Your detailed reflection on the results of the \
task and next steps.
...
- **Stop when adequate** - Don't over-research; stop when you \
...
You are creating a minimal summary for research steering - your goal is to help \
an agent know what information it has collected, NOT to preserve all details.
...
Keep the summary under 150 words total. The agent needs to know what's in this \
file to decide if it should search for more information or use this source.

Generate a descriptive filename that indicates the content type and topic \
(e.g., "mcp_protocol_overview.md", "ai_safety_research_2024.md").
...
to answer? What's still missing?
